...
class Base:
    ...
    def save_to_file(cls, list_objs):
        """Write the JSON serializations of a list of objects to a file.
        Args:
    ...
    def from_json_string(json_string):
        ...
        Return:
            ...
            Otherwise -  the python list reprisented by json _string.
        """
    ...
    def load_from_file_csv(cls):
        ...
        Returns:
            if the file does not exist - an empty list.
            otherwise -  alist of instantiated classes.
        """
        filename = cls.__name__ + ".csv"
        try:
    ...
    def draw(list_rectangles, list_squares):
        ...
        Args:
            list_rectangles (list): A list of Reactangle objects to draw.
