...
class TestRectangle_width(unittest.TestCase):
    """unittest for testing initialization of the Rectangle width attribute."""
...
class TestRectangle_height(unittest.TestCase):
    """unittest for testing initialization of the Rectangle height attribute."""
...
class TestRectangle_x(unittest.TestCase):
    """unittest for testing initialization of the Rectangle x attribute."""
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    ...
    def test_height_before_y(self):
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
            Rectangle(1, "invalid width", 2, "invalid y")

    def test_height_before_x(self):
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
            Rectangle(1, "invalid width", "invalid x")

    def test_x_before_y(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Rectangle(1, 2, "invalid x", "invalid x")
...
class TestRectangle_stdout(unittest.TestCase):
    """unittests for testing __str__ and display method of Rectangle class."""

    @staticmethod
    def capture_stdout(rect, method):
        '''captures and returns text printed to stdout.
        Args:
            rect (Rectangle): The rectangle to be captured
            method (str): The method to run on the captured
    ...
    # Test __str__ method
    def test_str_method_print_width_height():
        r = Rectangle(4, 6)
...
class TestRectangle_update_args(unittest.TestCase):
    ...
    def test_update_args_None_id(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(None, 4, 5, 2)
        correct = "[Rectangle] ({}) 2/10 - 4/10".format(r.id)
        self.assertEqual(correct, str(r))
...
class TestRectangle_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargs_four(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(id=89, x=1,  height=3, y=3, width=2)
        self.assertEqual("[Rectangle] (89) 1/3 - 4/2", str(r))

    def test_update_kwargs_five(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(y=5, x=8, id=99, width=1, height=2)
        self.assertEqual("[Rectangle] (99) 8/9 - 1/2", str(r))
    ...
    def test_update_args_and_kwargs(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(a=5, b=10)
        self.assertEqual("[Rectangle] (10) 10/10 - 2/10", str(r))

    def test_update_args_some_wrong_key(self):
        r = Rectangle(10, 10, 10, 10, 10)
