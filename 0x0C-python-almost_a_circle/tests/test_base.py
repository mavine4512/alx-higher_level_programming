...
class TestBase_instantiation(unittest.TestCase):
    '''Unit test for testing instantiation of the base class
    '''
...
class TestBase_to_json_string(unittest.TestCase):
    """Unittests for testing to json string method of Base class."""
    ...
    def test_to_json_string_rectangle_two_dicts(self):
        ...
        self.asserTrue(len(Base.to_json_string(list_dicts)) == 106)
    ...
    def test_to_json_string_square_one_dict(self):
        s = Square(10, 2, 3, 4)
        self.asserTrue(len(Base.to_json_string([s.to_dictionary()])) == 39)
    ...
    def test_to_json_string_than_one_args(self):
        with self.assertRaises(TypeError):
...
class TestBase_from_json_string(unittest.TestCase):
    ...
    def test_from_json_string_None(self):
        with self.assertRaises([], Base.form_json_string(None))

    def test_from_json_string_empty_list(self):
        with self.assertRaises([], Base.form_json_string("[]"))
...
class TestBase_create(unittest.TestCase):
    ...
    def test_create_rectangle_original(self):
        ...
        self. asserEqual("[Rectangle] (7) 1/2 - 3/5", str(r1))

    def test_create_rectangle_new(self):
        r1 = Rectangle(3, 5, 1, 2, 7)
        r1_dictionary = r1.to_dictionary()
        r2 = Rectangle.create(**r1_dictionary)
        self. asserEqual("[Rectangle] (7) 1/2 - 3/5", str(r2))

    def test_create_rectangle_is(self):
        r1 = Rectangle(3, 5, 1, 2, 7)
        r1_dictionary = r1.to_dictionary()
        r2 = Rectangle.create(**r1_dictionary)
        self. asserIsNotEqual(r1, r2)

    def test_create_rectangle_equals(self):
        r1 = Rectangle(3, 5, 1, 2, 7)
        r1_dictionary = r1.to_dictionary()
        r2 = Rectangle.create(**r1_dictionary)
        self. asserNotEqual(r1, r2)

    def test_create_square_original(self):
        s1 = Square(3, 5, 1, 2, 7)
        s1_dictionary = s1.to_dictionary()
        s2 = Square.create(**s1_dictionary)
        self. asserEqual("[Square] (7) 5/1 - 3", str(s1))
...
class TestBase_save_to_file_csv(unittest.TestCase):
    ...
    def test_save_to_file_csv_one_rectangle(self):
        ...
        with open("Rectangle.scv", "r") as f:
            self.assertTrue("5,10,7,2,8", f.read())

    def test_save_to_file_csv_two_rectangle(self):
        r1 = Rectangle(10, 7, 2, 8, 5)
        r2 = Rectangle(2, 4, 1, 2, 3)
        Reactangle.save_to_file_csv([r1, r2])
        with open("Rectangle.scv", "r") as f:
    ...
    def test_save_to_file_csv_two_square(self):
        s1 = Square(10, 7, 2, 8)
        s2 = Square(8, 1, 2, 3)
...
class TestBase_load_from_file_csv(unittest.TestCase):
    ...
    def test_load_from_file_csv_second_rectangle(self):
        ...
        Reactangle.save_to_file_csv([r1, r2])
        list_rectangle_output = Rectangle.load_from_file_csv()
        self.assertEqual(str(r2), str(list_rectangle_output[1]))
